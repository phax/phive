...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN business_rules-->
	  ...
	  <!--RULE -->
   <xsl:template match="ubl:OrderResponse" priority="1003" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:BuyerCustomerParty" priority="1002" mode="M4">
	  ...
	  <!--RULE -->
   <xsl:template match="cac:SellerSupplierParty" priority="1001" mode="M4">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:OrderLine" priority="1000" mode="M4">
   ...
   <xsl:variable name="mime"
	  ...
	  <!--RULE -->
   <xsl:template match="cbc:*[@mimeCode]" priority="1004" mode="M5">
	  ...
	  <!--RULE -->
   <xsl:template match="@currencyID" priority="1003" mode="M5">
   ...
   <xsl:template match="cbc:ItemClassificationCode/@listID"
	  ...
	  <!--RULE -->
   <xsl:template match="cac:ClassifiedTaxCategory/cbc:ID" priority="1000" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
