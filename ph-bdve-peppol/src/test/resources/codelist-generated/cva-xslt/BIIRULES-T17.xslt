...
<stylesheet exclude-result-prefixes="ccs" version="2.0" xmlns="http://www.w3.org/1999/XSL/Transform">
  ...
  <template match="/">
    <for-each select="document('')">
      <ns0:pattern id="BIIRULES-T17" xmlns:ns0="http://purl.oclc.org/dsdl/schematron">
...
<!--{}(TaxCategoryID)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d51e3">
