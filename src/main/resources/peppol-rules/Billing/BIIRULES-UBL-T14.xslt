...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="@currencyID" mode="M7" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="@mimeCode" mode="M7" priority="1001">
...
<!--PATTERN UBL-T14-->
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AllowanceCharge" mode="M8" priority="1005">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote" mode="M8" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:CreditNoteLine" mode="M8" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:InvoicePeriod" mode="M8" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:LegalMonetaryTotal" mode="M8" priority="1001">
    <svrl:fired-rule context="//cac:LegalMonetaryTotal" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(xs:decimal(cbc:LineExtensionAmount)) = (round(sum(xs:decimal(//cac:CreditNoteLine/cbc:LineExtensionAmount)) * 10 * 10) div 100)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(xs:decimal(cbc:LineExtensionAmount)) = (round(sum(xs:decimal(//cac:CreditNoteLine/cbc:LineExtensionAmount)) * 10 * 10) div 100)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(xs:decimal(cbc:AllowanceTotalAmount)) = (round(sum(xs:decimal(/ubl:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator=&quot;false&quot;]/cbc:Amount)) * 10 * 10) div 100) or not(cbc:AllowanceTotalAmount)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(xs:decimal(cbc:AllowanceTotalAmount)) = (round(sum(xs:decimal(/ubl:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator=&quot;false&quot;]/cbc:Amount)) * 10 * 10) div 100) or not(cbc:AllowanceTotalAmount)">
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(xs:decimal(cbc:ChargeTotalAmount)) = (round(sum(xs:decimal(/ubl:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator=&quot;true&quot;]/cbc:Amount)) * 10 * 10) div 100) or not(cbc:ChargeTotalAmount)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(xs:decimal(cbc:ChargeTotalAmount)) = (round(sum(xs:decimal(/ubl:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator=&quot;true&quot;]/cbc:Amount)) * 10 * 10) div 100) or not(cbc:ChargeTotalAmount)">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="((cbc:PrepaidAmount) and ((xs:decimal(cbc:PayableAmount)) = (round((xs:decimal(cbc:TaxInclusiveAmount) - xs:decimal(cbc:PrepaidAmount)) * 10 * 10) div 100))) or (cbc:PayableAmount = cbc:TaxInclusiveAmount)">
