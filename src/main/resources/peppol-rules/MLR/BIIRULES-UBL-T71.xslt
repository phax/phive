...
<!--PATTERN Codes-T71-->
	...
	<!--RULE -->
<xsl:template match="cac:DocumentResponse/cac:DocumentReference/cbc:DocumentTypeCode" mode="M7" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:DocumentResponse/cac:Response/cbc:ResponseCode" mode="M7" priority="1000">
...
<!--PATTERN UBL-T71-->
	...
	<!--RULE -->
<xsl:template match="//cac:ReceiverParty" mode="M8" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:SenderParty" mode="M8" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:ApplicationResponse" mode="M8" priority="1000">
