...
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="OPENPEPPOL T58 bound to UBL">
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="id">Codes-T58</xsl:attribute>
        <xsl:attribute name="name">Codes-T58</xsl:attribute>
        <xsl:apply-templates />
      </svrl:active-pattern>
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cbc:ResponseCode" mode="M7" priority="1000">
...
<!--PATTERN UBL-T58-->
	...
	<!--RULE -->
<xsl:template match="//cbc:EndpointID" mode="M8" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cbc:ResponseCode" mode="M8" priority="1000">
    <svrl:fired-rule context="//cbc:ResponseCode" />
