...
<!--PATTERN UBL-T76-->
	...
	<!--RULE -->
<xsl:template match="//cac:BuyerCustomerParty" mode="M7" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:SellerSupplierParty" mode="M7" priority="1002">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:OrderResponse" mode="M7" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:OrderLine" mode="M7" priority="1000">
