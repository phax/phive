...
<stylesheet exclude-result-prefixes="ccs" version="2.0" xmlns="http://www.w3.org/1999/XSL/Transform">
  ...
  <template match="/">
    <for-each select="document('')">
      <ns0:pattern id="OPENPEPPOL-T58" xmlns:ns0="http://purl.oclc.org/dsdl/schematron">
...
<ns0:rule context="cbc:EndpointID/@schemeID" flag="fatal" role="fatal">
  ...
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;FR:SIRENE&#127;SE:ORGNR&#127;FR:SIRET&#127;FI:OVT&#127;DUNS&#127;GLN&#127;DK:P&#127;IT:FTI&#127;NL:KVK&#127;IT:SIA&#127;IT:SECETI&#127;DK:CPR&#127;DK:CVR&#127;DK:SE&#127;DK:VANS&#127;IT:VAT&#127;IT:CF&#127;NO:ORGNR&#127;NO:VAT&#127;HU:VAT&#127;EU:REID&#127;AT:VAT&#127;AT:GOV&#127;IS:KT&#127;IBAN&#127;AT:KUR&#127;ES:VAT&#127;IT:IPA&#127;AD:VAT&#127;AL:VAT&#127;BA:VAT&#127;BE:VAT&#127;BG:VAT&#127;CH:VAT&#127;CY:VAT&#127;CZ:VAT&#127;DE:VAT&#127;EE:VAT&#127;GB:VAT&#127;GR:VAT&#127;HR:VAT&#127;IE:VAT&#127;LI:VAT&#127;LT:VAT&#127;LU:VAT&#127;LV:VAT&#127;MC:VAT&#127;ME:VAT&#127;MK:VAT&#127;MT:VAT&#127;NL:VAT&#127;PL:VAT&#127;PT:VAT&#127;RO:VAT&#127;RS:VAT&#127;SI:VAT&#127;SK:VAT&#127;SM:VAT&#127;TR:VAT&#127;VA:VAT&#127;NL:ION&#127;SE:VAT&#127;ZZZ&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T58-R001]-An Endpoint Identifier Scheme MUST be from the list of PEPPOL Party Identifiers described in the "PEPPOL Policy for using Identifiers".          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cac:PartyIdentification/cbc:ID/@schemeID" flag="fatal" role="fatal">
  ...
  <text xml:space="preserve">
          ...
          <comment>{}[](PartyIdentifierScheme)</comment>
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;FR:SIRENE&#127;SE:ORGNR&#127;FR:SIRET&#127;FI:OVT&#127;DUNS&#127;GLN&#127;DK:P&#127;IT:FTI&#127;NL:KVK&#127;IT:SIA&#127;IT:SECETI&#127;DK:CPR&#127;DK:CVR&#127;DK:SE&#127;DK:VANS&#127;IT:VAT&#127;IT:CF&#127;NO:ORGNR&#127;NO:VAT&#127;HU:VAT&#127;EU:REID&#127;AT:VAT&#127;AT:GOV&#127;IS:KT&#127;IBAN&#127;AT:KUR&#127;ES:VAT&#127;IT:IPA&#127;AD:VAT&#127;AL:VAT&#127;BA:VAT&#127;BE:VAT&#127;BG:VAT&#127;CH:VAT&#127;CY:VAT&#127;CZ:VAT&#127;DE:VAT&#127;EE:VAT&#127;GB:VAT&#127;GR:VAT&#127;HR:VAT&#127;IE:VAT&#127;LI:VAT&#127;LT:VAT&#127;LU:VAT&#127;LV:VAT&#127;MC:VAT&#127;ME:VAT&#127;MK:VAT&#127;MT:VAT&#127;NL:VAT&#127;PL:VAT&#127;PT:VAT&#127;RO:VAT&#127;RS:VAT&#127;SI:VAT&#127;SK:VAT&#127;SM:VAT&#127;TR:VAT&#127;VA:VAT&#127;NL:ION&#127;SE:VAT&#127;ZZZ&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T58-R002]-A Party Identifier Scheme MUST be from the list of PEPPOL Party Identifiers described in the "PEPPOL Policy for using Identifiers".          </ns0:assert>
</ns0:rule>

<ns0:rule context="cbc:ResponseCode" flag="fatal" role="fatal">
  <!--{}[](ResponseCode)-->
  <text xml:space="preserve">
      </text>
          <comment>{}[](ResponseCode)</comment>
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;AP&#127;RE&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T58-R003]-A Response code MUST be from the UN CEFACT 4343 code list PEPPOL subset          </ns0:assert>
</ns0:rule>
<!--
...
<!--{}(PartyIdentifierScheme)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d236e3">
...
<!--{}(ResponseCode)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d236e4">
