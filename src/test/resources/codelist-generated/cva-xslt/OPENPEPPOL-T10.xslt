...
<stylesheet exclude-result-prefixes="ccs" version="2.0" xmlns="http://www.w3.org/1999/XSL/Transform">
  ...
  <template match="/">
    <for-each select="document('')">
      <ns0:pattern id="OPENPEPPOL-T10" xmlns:ns0="http://purl.oclc.org/dsdl/schematron">
...
<ns0:rule context="cbc:EndpointID/@schemeID" flag="fatal" role="fatal">
  ...
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;FR:SIRENE&#127;SE:ORGNR&#127;FR:SIRET&#127;FI:OVT&#127;DUNS&#127;GLN&#127;DK:P&#127;IT:FTI&#127;NL:KVK&#127;IT:SIA&#127;IT:SECETI&#127;DK:CPR&#127;DK:CVR&#127;DK:SE&#127;DK:VANS&#127;IT:VAT&#127;IT:CF&#127;NO:ORGNR&#127;NO:VAT&#127;HU:VAT&#127;EU:REID&#127;AT:VAT&#127;AT:GOV&#127;IS:KT&#127;IBAN&#127;AT:KUR&#127;ES:VAT&#127;IT:IPA&#127;AD:VAT&#127;AL:VAT&#127;BA:VAT&#127;BE:VAT&#127;BG:VAT&#127;CH:VAT&#127;CY:VAT&#127;CZ:VAT&#127;DE:VAT&#127;EE:VAT&#127;GB:VAT&#127;GR:VAT&#127;HR:VAT&#127;IE:VAT&#127;LI:VAT&#127;LT:VAT&#127;LU:VAT&#127;LV:VAT&#127;MC:VAT&#127;ME:VAT&#127;MK:VAT&#127;MT:VAT&#127;NL:VAT&#127;PL:VAT&#127;PT:VAT&#127;RO:VAT&#127;RS:VAT&#127;SI:VAT&#127;SK:VAT&#127;SM:VAT&#127;TR:VAT&#127;VA:VAT&#127;NL:ION&#127;SE:VAT&#127;ZZZ&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R002]-An Endpoint Identifier Scheme MUST be from the list of PEPPOL Party Identifiers described in the "PEPPOL Policy for using Identifiers".          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cac:PartyIdentification/cbc:ID/@schemeID" flag="fatal" role="fatal">
  ...
  <text xml:space="preserve">
          ...
          <comment>{}[](PartyIdentifierScheme)</comment>
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;FR:SIRENE&#127;SE:ORGNR&#127;FR:SIRET&#127;FI:OVT&#127;DUNS&#127;GLN&#127;DK:P&#127;IT:FTI&#127;NL:KVK&#127;IT:SIA&#127;IT:SECETI&#127;DK:CPR&#127;DK:CVR&#127;DK:SE&#127;DK:VANS&#127;IT:VAT&#127;IT:CF&#127;NO:ORGNR&#127;NO:VAT&#127;HU:VAT&#127;EU:REID&#127;AT:VAT&#127;AT:GOV&#127;IS:KT&#127;IBAN&#127;AT:KUR&#127;ES:VAT&#127;IT:IPA&#127;AD:VAT&#127;AL:VAT&#127;BA:VAT&#127;BE:VAT&#127;BG:VAT&#127;CH:VAT&#127;CY:VAT&#127;CZ:VAT&#127;DE:VAT&#127;EE:VAT&#127;GB:VAT&#127;GR:VAT&#127;HR:VAT&#127;IE:VAT&#127;LI:VAT&#127;LT:VAT&#127;LU:VAT&#127;LV:VAT&#127;MC:VAT&#127;ME:VAT&#127;MK:VAT&#127;MT:VAT&#127;NL:VAT&#127;PL:VAT&#127;PT:VAT&#127;RO:VAT&#127;RS:VAT&#127;SI:VAT&#127;SK:VAT&#127;SM:VAT&#127;TR:VAT&#127;VA:VAT&#127;NL:ION&#127;SE:VAT&#127;ZZZ&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R003]-An Party Identifier Scheme MUST be from the list of PEPPOL Party Identifiers described in the "PEPPOL Policy for using Identifiers".          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cac:PayeeFinancialAccount/cbc:ID/@schemeID" flag="fatal" role="fatal">
  ...
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;IBAN&#127;LOCAL&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R004]-A payee account identifier scheme MUST be from the Account ID PEPPOL code list          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cac:Item/cac:StandardItemIdentification/cbc:ID/@schemeID" flag="fatal" role="fatal">
  ...
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;CV&#127;GN&#127;HS&#127;CPV&#127;UNSPSC&#127;eCl@ss&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R007]-A standard item identifier scheme MUST be coded according to the list Item Identifier Scheme ID defined by PEPPOL          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cbc:CompanyID/@schemeID" flag="fatal" role="fatal">
  ...
  <text xml:space="preserve">
          ...
          <comment>{}[](PartyIdentifierScheme)</comment>
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;FR:SIRENE&#127;SE:ORGNR&#127;FR:SIRET&#127;FI:OVT&#127;DUNS&#127;GLN&#127;DK:P&#127;IT:FTI&#127;NL:KVK&#127;IT:SIA&#127;IT:SECETI&#127;DK:CPR&#127;DK:CVR&#127;DK:SE&#127;DK:VANS&#127;IT:VAT&#127;IT:CF&#127;NO:ORGNR&#127;NO:VAT&#127;HU:VAT&#127;EU:REID&#127;AT:VAT&#127;AT:GOV&#127;IS:KT&#127;IBAN&#127;AT:KUR&#127;ES:VAT&#127;IT:IPA&#127;AD:VAT&#127;AL:VAT&#127;BA:VAT&#127;BE:VAT&#127;BG:VAT&#127;CH:VAT&#127;CY:VAT&#127;CZ:VAT&#127;DE:VAT&#127;EE:VAT&#127;GB:VAT&#127;GR:VAT&#127;HR:VAT&#127;IE:VAT&#127;LI:VAT&#127;LT:VAT&#127;LU:VAT&#127;LV:VAT&#127;MC:VAT&#127;ME:VAT&#127;MK:VAT&#127;MT:VAT&#127;NL:VAT&#127;PL:VAT&#127;PT:VAT&#127;RO:VAT&#127;RS:VAT&#127;SI:VAT&#127;SK:VAT&#127;SM:VAT&#127;TR:VAT&#127;VA:VAT&#127;NL:ION&#127;SE:VAT&#127;ZZZ&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R008]-A Party Company Identifier Scheme MUST be from the list of PEPPOL Party Identifiers described in the "PEPPOL Policy for using Identifiers".          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cbc:SourceCurrencyCode" flag="fatal" role="fatal">
  ...
  <text xml:space="preserve">
          ...
          <comment>{}[](CurrencyCodeList)</comment>
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;AED&#127;AFN&#127;ALL&#127;AMD&#127;ANG&#127;AOA&#127;ARS&#127;AUD&#127;AWG&#127;AZN&#127;BAM&#127;BBD&#127;BDT&#127;BGN&#127;BHD&#127;BIF&#127;BMD&#127;BND&#127;BOB&#127;BOV&#127;BRL&#127;BSD&#127;BTN&#127;BWP&#127;BYR&#127;BZD&#127;CAD&#127;CDF&#127;CHE&#127;CHF&#127;CHW&#127;CLF&#127;CLP&#127;CNY&#127;COP&#127;COU&#127;CRC&#127;CUP&#127;CVE&#127;CZK&#127;DJF&#127;DKK&#127;DOP&#127;DZD&#127;EEK&#127;EGP&#127;ERN&#127;ETB&#127;EUR&#127;FJD&#127;FKP&#127;GBP&#127;GEL&#127;GHS&#127;GIP&#127;GMD&#127;GNF&#127;GTQ&#127;GWP&#127;GYD&#127;HKD&#127;HNL&#127;HRK&#127;HTG&#127;HUF&#127;IDR&#127;ILS&#127;INR&#127;IQD&#127;IRR&#127;ISK&#127;JMD&#127;JOD&#127;JPY&#127;KES&#127;KGS&#127;KHR&#127;KMF&#127;KPW&#127;KRW&#127;KWD&#127;KYD&#127;KZT&#127;LAK&#127;LBP&#127;LKR&#127;LRD&#127;LSL&#127;LTL&#127;LVL&#127;LYD&#127;MAD&#127;MDL&#127;MGA&#127;MKD&#127;MMK&#127;MNT&#127;MOP&#127;MRO&#127;MUR&#127;MVR&#127;MWK&#127;MXN&#127;MXV&#127;MYR&#127;MZN&#127;NAD&#127;NGN&#127;NIO&#127;NOK&#127;NPR&#127;NZD&#127;OMR&#127;PAB&#127;PEN&#127;PGK&#127;PHP&#127;PKR&#127;PLN&#127;PYG&#127;QAR&#127;RON&#127;RSD&#127;RUB&#127;RWF&#127;SAR&#127;SBD&#127;SCR&#127;SDG&#127;SEK&#127;SGD&#127;SHP&#127;SKK&#127;SLL&#127;SOS&#127;SRD&#127;STD&#127;SVC&#127;SYP&#127;SZL&#127;THB&#127;TJS&#127;TMM&#127;TND&#127;TOP&#127;TRY&#127;TTD&#127;TWD&#127;TZS&#127;UAH&#127;UGX&#127;USD&#127;USN&#127;USS&#127;UYI&#127;UYU&#127;UZS&#127;VEF&#127;VND&#127;VUV&#127;WST&#127;XAF&#127;XAG&#127;XAU&#127;XBA&#127;XBB&#127;XBC&#127;XBD&#127;XCD&#127;XDR&#127;XFU&#127;XOF&#127;XPD&#127;XPF&#127;XTS&#127;XXX&#127;YER&#127;ZAR&#127;ZMK&#127;ZWR&#127;ZWD&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R010]-SourceCurrencyCode MUST be coded using ISO code list 4217          </ns0:assert>
</ns0:rule>
...
<ns0:rule context="cbc:TargetCurrencyCode" flag="fatal" role="fatal">
  ...
  <text xml:space="preserve">
          ...
          <comment>{}[](CurrencyCodeList)</comment>
  <ns0:assert flag="fatal">
            <attribute name="test">( false() or ( contains('&#127;AED&#127;AFN&#127;ALL&#127;AMD&#127;ANG&#127;AOA&#127;ARS&#127;AUD&#127;AWG&#127;AZN&#127;BAM&#127;BBD&#127;BDT&#127;BGN&#127;BHD&#127;BIF&#127;BMD&#127;BND&#127;BOB&#127;BOV&#127;BRL&#127;BSD&#127;BTN&#127;BWP&#127;BYR&#127;BZD&#127;CAD&#127;CDF&#127;CHE&#127;CHF&#127;CHW&#127;CLF&#127;CLP&#127;CNY&#127;COP&#127;COU&#127;CRC&#127;CUP&#127;CVE&#127;CZK&#127;DJF&#127;DKK&#127;DOP&#127;DZD&#127;EEK&#127;EGP&#127;ERN&#127;ETB&#127;EUR&#127;FJD&#127;FKP&#127;GBP&#127;GEL&#127;GHS&#127;GIP&#127;GMD&#127;GNF&#127;GTQ&#127;GWP&#127;GYD&#127;HKD&#127;HNL&#127;HRK&#127;HTG&#127;HUF&#127;IDR&#127;ILS&#127;INR&#127;IQD&#127;IRR&#127;ISK&#127;JMD&#127;JOD&#127;JPY&#127;KES&#127;KGS&#127;KHR&#127;KMF&#127;KPW&#127;KRW&#127;KWD&#127;KYD&#127;KZT&#127;LAK&#127;LBP&#127;LKR&#127;LRD&#127;LSL&#127;LTL&#127;LVL&#127;LYD&#127;MAD&#127;MDL&#127;MGA&#127;MKD&#127;MMK&#127;MNT&#127;MOP&#127;MRO&#127;MUR&#127;MVR&#127;MWK&#127;MXN&#127;MXV&#127;MYR&#127;MZN&#127;NAD&#127;NGN&#127;NIO&#127;NOK&#127;NPR&#127;NZD&#127;OMR&#127;PAB&#127;PEN&#127;PGK&#127;PHP&#127;PKR&#127;PLN&#127;PYG&#127;QAR&#127;RON&#127;RSD&#127;RUB&#127;RWF&#127;SAR&#127;SBD&#127;SCR&#127;SDG&#127;SEK&#127;SGD&#127;SHP&#127;SKK&#127;SLL&#127;SOS&#127;SRD&#127;STD&#127;SVC&#127;SYP&#127;SZL&#127;THB&#127;TJS&#127;TMM&#127;TND&#127;TOP&#127;TRY&#127;TTD&#127;TWD&#127;TZS&#127;UAH&#127;UGX&#127;USD&#127;USN&#127;USS&#127;UYI&#127;UYU&#127;UZS&#127;VEF&#127;VND&#127;VUV&#127;WST&#127;XAF&#127;XAG&#127;XAU&#127;XBA&#127;XBB&#127;XBC&#127;XBD&#127;XCD&#127;XDR&#127;XFU&#127;XOF&#127;XPD&#127;XPF&#127;XTS&#127;XXX&#127;YER&#127;ZAR&#127;ZMK&#127;ZWR&#127;ZWD&#127;',concat('&#127;',.,'&#127;')) ) ) </attribute>[OP-T10-R011]-TargetCurrencyCode MUST be coded using ISO code list 4217          </ns0:assert>
</ns0:rule>
<!--
...
<!--{}(AccountID)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d124e3">
...
<!--{}(CommodityCode)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d124e4">
...
<!--{}(CurrencyCodeList)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d124e5">
...
<!--{}(PartyIdentifierScheme)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d124e6">
...
<!--{}(UnitCode)-->
<ns0:Identification xmlns:ns0="urn:x-Crane:ss:Crane-Constraints2Schematron" xml:id="d124e7">
