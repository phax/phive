<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      <rule context="/ubl:Catalogue">
         ...
         <assert test="cbc:ActionCode" flag="warning" id="EHF-T77-B00105">Element 'cbc:ActionCode' MUST be provided.</assert>
         <assert test="cbc:IssueDate" flag="warning" id="EHF-T77-B00106">Element 'cbc:IssueDate' MUST be provided.</assert>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:RequiredItemLocationQuantity">
         <assert test="cbc:LeadTimeMeasure" flag="warning" id="EHF-T77-B02901">Element 'cbc:LeadTimeMeasure' MUST be provided.</assert>
         <assert test="cac:Price" flag="warning" id="EHF-T77-B02902">Element 'cac:Price' MUST be provided.</assert>
         <assert test="cac:DeliveryUnit" flag="warning" id="EHF-T77-B02903">Element 'cac:DeliveryUnit' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:ItemSpecificationDocumentReference">
         ...
         <assert test="cbc:DocumentTypeCode" flag="warning" id="EHF-T77-B05202">Element 'cbc:DocumentTypeCode' MUST be provided.</assert>
         <assert test="cbc:DocumentDescription" flag="warning" id="EHF-T77-B05203">Element 'cbc:DocumentDescription' MUST be provided.</assert>
      </rule>
