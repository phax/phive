<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:OrderResponse/cac:DeliveryTerms">
         <assert test="cbc:ID" flag="warning" id="EHF-T110-B09701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:OrderResponse/cac:OrderLine/cac:LineItem/cac:Item/cac:Certificate/cac:DocumentReference">
         <assert test="cbc:ID" flag="warning" id="EHF-T110-B21001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
