<schema xmlns="http://purl.oclc.org/dsdl/schematron"
   ...
   <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:DespatchAdvice/cac:DespatchSupplierParty/cac:Party/cac:Contact">
         <assert test="cbc:ElectronicMail" flag="warning" id="EHF-T16-B02001">Element 'cbc:ElectronicMail' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:DespatchAdvice/cac:DeliveryCustomerParty/cac:DeliveryContact">
         <assert test="cbc:ElectronicMail" flag="warning" id="EHF-T16-B04701">Element 'cbc:ElectronicMail' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:DespatchAdvice/cac:SellerSupplierParty/cac:Party/cac:Contact">
         <assert test="cbc:ElectronicMail" flag="warning" id="EHF-T16-B06601">Element 'cbc:ElectronicMail' MUST be provided.</assert>
      </rule>
