  ...
  <ns prefix="xs"   uri="http://www.w3.org/2001/XMLSchema"/>
    ...
    <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      <rule context="/ubl:Invoice">
         ...
         <assert test="cac:PaymentMeans " flag="warning" id="EHF-T10-B00110">Element 'cac:PaymentMeans ' MUST be provided.</assert>
         <assert test="cac:TaxTotal" flag="warning" id="EHF-T10-B00111">Element 'cac:TaxTotal' MUST be provided.</assert>
         <assert test="cac:LegalMonetaryTotal" flag="warning" id="EHF-T10-B00112">Element 'cac:LegalMonetaryTotal' MUST be provided.</assert>
         <assert test="cac:InvoiceLine" flag="warning" id="EHF-T10-B00113">Element 'cac:InvoiceLine' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cac:ExternalReference">
         <assert test="cbc:URI" flag="warning" id="EHF-T10-B03201">Element 'cbc:URI' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T10-B10301">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T10-B12901">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T10-B14701">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:PaymentMeans ">
         <assert test="cbc:PaymentMeansCode" flag="warning" id="EHF-T10-B15001">Element 'cbc:PaymentMeansCode' MUST be provided.</assert>
         <assert test="cbc:PaymentDueDate" flag="warning" id="EHF-T10-B15002">Element 'cbc:PaymentDueDate' MUST be provided.</assert>
         <assert test="cac:PayeeFinancialAccount" flag="warning" id="EHF-T10-B15003">Element 'cac:PayeeFinancialAccount' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentMeansCode">
         <assert test="@listID" flag="warning" id="EHF-T10-B15101">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentDueDate"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cbc:PaymentChannelCode"/>
      ...
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B15601">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cbc:ID">
         <assert test="@schemeID" flag="warning" id="EHF-T10-B15701">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B16101">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cbc:ID"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cbc:Name"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:StreetName"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:AdditionalStreetName"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CityName"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:PostalZone"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cbc:CountrySubentity"/>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T10-B17101">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentMeans /cac:PayeeFinancialAccount/cac:FinancialInstitutionBranch/cac:FinancialInstitution/cac:Address/cac:Country/cbc:IdentificationCode">
         <assert test="not(@listID) or @listID = 'ISO3166-1:Alpha2'"
                 flag="fatal"
                 id="EHF-T10-B17201">Attribute 'listID' MUST contain value 'ISO3166-1:Alpha2'</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentTerms">
         <assert test="cbc:Note" flag="warning" id="EHF-T10-B17401">Element 'cbc:Note' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:PaymentTerms/cbc:Note"/>
      <rule context="/ubl:Invoice/cac:AllowanceCharge">
         <assert test="cbc:ChargeIndicator" flag="warning" id="EHF-T10-B17601">Element 'cbc:ChargeIndicator' MUST be provided.</assert>
         <assert test="cbc:Amount" flag="warning" id="EHF-T10-B17602">Element 'cbc:Amount' MUST be provided.</assert>
      ...
      <rule context="/ubl:Invoice/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode">
         <assert test="@listID" flag="warning" id="EHF-T10-B17801">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory">
         ...
         <assert test="cac:TaxScheme" flag="warning" id="EHF-T10-B18302">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B18701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:TaxExchangeRate">
         <assert test="cbc:SourceCurrencyCode" flag="warning" id="EHF-T10-B18901">Element 'cbc:SourceCurrencyCode' MUST be provided.</assert>
         <assert test="cbc:TargetCurrencyCode" flag="warning" id="EHF-T10-B18902">Element 'cbc:TargetCurrencyCode' MUST be provided.</assert>
         <assert test="cbc:CalculationRate" flag="warning" id="EHF-T10-B18903">Element 'cbc:CalculationRate' MUST be provided.</assert>
         <assert test="cbc:MathematicOperatorCode"
                 flag="warning"
                 id="EHF-T10-B18904">Element 'cbc:MathematicOperatorCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:TaxExchangeRate/cbc:SourceCurrencyCode">
         <assert test="@listID" flag="warning" id="EHF-T10-B19001">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:TaxExchangeRate/cbc:TargetCurrencyCode">
         <assert test="@listID" flag="warning" id="EHF-T10-B19201">Attribute 'listID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:TaxExchangeRate/cbc:MathematicOperatorCode">
         <assert test="normalize-space(text()) = 'Multiply'"
                 flag="warning"
                 id="EHF-T10-B19501">Element 'cbc:MathematicOperatorCode' MUST contain value 'Multiply'.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:TaxExchangeRate/cbc:Date"/>
      <rule context="/ubl:Invoice/cac:TaxTotal">
         <assert test="cbc:TaxAmount" flag="warning" id="EHF-T10-B19701">Element 'cbc:TaxAmount' MUST be provided.</assert>
         <assert test="cac:TaxSubtotal" flag="warning" id="EHF-T10-B19702">Element 'cac:TaxSubtotal' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:TaxTotal/cbc:TaxAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B19801">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal">
         <assert test="cbc:TaxableAmount" flag="warning" id="EHF-T10-B20001">Element 'cbc:TaxableAmount' MUST be provided.</assert>
         <assert test="cbc:TaxAmount" flag="warning" id="EHF-T10-B20002">Element 'cbc:TaxAmount' MUST be provided.</assert>
         <assert test="cac:TaxCategory" flag="warning" id="EHF-T10-B20003">Element 'cac:TaxCategory' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory">
         ...
         <assert test="cbc:Percent" flag="warning" id="EHF-T10-B20702">Element 'cbc:Percent' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="warning" id="EHF-T10-B20703">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:ID">
         <assert test="@schemeID" flag="warning" id="EHF-T10-B20801">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B21201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal">
         <assert test="cbc:LineExtensionAmount" flag="warning" id="EHF-T10-B21401">Element 'cbc:LineExtensionAmount' MUST be provided.</assert>
         <assert test="cbc:TaxExclusiveAmount" flag="warning" id="EHF-T10-B21402">Element 'cbc:TaxExclusiveAmount' MUST be provided.</assert>
         <assert test="cbc:TaxInclusiveAmount" flag="warning" id="EHF-T10-B21403">Element 'cbc:TaxInclusiveAmount' MUST be provided.</assert>
         <assert test="cbc:PayableAmount" flag="warning" id="EHF-T10-B21404">Element 'cbc:PayableAmount' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:LineExtensionAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B21501">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B21701">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B21901">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B22101">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B22301">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:PrepaidAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B22501">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:PayableRoundingAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B22701">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B22901">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B23101">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cbc:InvoicedQuantity" flag="warning" id="EHF-T10-B23102">Element 'cbc:InvoicedQuantity' MUST be provided.</assert>
         <assert test="cbc:LineExtensionAmount" flag="warning" id="EHF-T10-B23103">Element 'cbc:LineExtensionAmount' MUST be provided.</assert>
         <assert test="cac:Item" flag="warning" id="EHF-T10-B23104">Element 'cac:Item' MUST be provided.</assert>
         <assert test="cac:Price" flag="warning" id="EHF-T10-B23105">Element 'cac:Price' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cbc:InvoicedQuantity">
         <assert test="@unitCode" flag="warning" id="EHF-T10-B23401">Attribute 'unitCode' MUST be present.</assert>
         <assert test="@unitCodeListID" flag="warning" id="EHF-T10-B23402">Attribute 'unitCodeListID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cbc:LineExtensionAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B23701">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:OrderLineReference">
         <assert test="cbc:LineID" flag="warning" id="EHF-T10-B24301">Element 'cbc:LineID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery">
         <assert test="cbc:ActualDeliveryDate" flag="warning" id="EHF-T10-B24501">Element 'cbc:ActualDeliveryDate' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address">
         <assert test="cac:Country" flag="warning" id="EHF-T10-B25001">Element 'cac:Country' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T10-B25601">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address/cac:Country/cbc:IdentificationCode">
         <assert test="@listID" flag="warning" id="EHF-T10-B25701">Attribute 'listID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge">
         <assert test="cbc:ChargeIndicator" flag="warning" id="EHF-T10-B25901">Element 'cbc:ChargeIndicator' MUST be provided.</assert>
         <assert test="cbc:Amount" flag="warning" id="EHF-T10-B25902">Element 'cbc:Amount' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge/cbc:Amount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B26201">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:TaxTotal">
         <assert test="cbc:TaxAmount" flag="warning" id="EHF-T10-B26401">Element 'cbc:TaxAmount' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:TaxTotal/cbc:TaxAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B26501">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item">
         ...
         <assert test="cac:ClassifiedTaxCategory" flag="warning" id="EHF-T10-B26702">Element 'cac:ClassifiedTaxCategory' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:SellersItemIdentification">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B27001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:StandardItemIdentification">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B27201">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:OriginCountry">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T10-B27501">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:OriginCountry/cbc:IdentificationCode">
         <assert test="not(@listID) or @listID = 'ISO3166-1:Alpha2'"
                 flag="fatal"
                 id="EHF-T10-B27601">Attribute 'listID' MUST contain value 'ISO3166-1:Alpha2'</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:CommodityClassification">
         <assert test="cbc:ItemClassificationCode"
                 flag="warning"
                 id="EHF-T10-B27801">Element 'cbc:ItemClassificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B28101">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="warning" id="EHF-T10-B28102">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme">
         <assert test="cbc:ID" flag="warning" id="EHF-T10-B28501">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:AdditionalItemProperty">
         <assert test="cbc:Name" flag="warning" id="EHF-T10-B28701">Element 'cbc:Name' MUST be provided.</assert>
         <assert test="cbc:Value" flag="warning" id="EHF-T10-B28702">Element 'cbc:Value' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty">
         <assert test="cac:PartyName" flag="warning" id="EHF-T10-B29001">Element 'cac:PartyName' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyName">
         <assert test="cbc:Name" flag="warning" id="EHF-T10-B29101">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Item/cac:ManufacturerParty/cac:PartyLegalEntity/cbc:CompanyID">
         <assert test="@schemeID" flag="warning" id="EHF-T10-B29401">Attribute 'schemeID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price">
         <assert test="cbc:PriceAmount" flag="warning" id="EHF-T10-B29601">Element 'cbc:PriceAmount' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cbc:PriceAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B29701">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge">
         <assert test="cbc:ChargeIndicator" flag="warning" id="EHF-T10-B30001">Element 'cbc:ChargeIndicator' MUST be provided.</assert>
         <assert test="cbc:Amount" flag="warning" id="EHF-T10-B30002">Element 'cbc:Amount' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:Amount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B30401">Attribute 'currencyID' MUST be present.</assert>
      </rule>
      <rule context="/ubl:Invoice/cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount">
         <assert test="@currencyID" flag="warning" id="EHF-T10-B30601">Attribute 'currencyID' MUST be present.</assert>
      </rule>
   </pattern>
    <pattern>
      <let name="isB2C"
