  ...
  <ns prefix="xs"   uri="http://www.w3.org/2001/XMLSchema"/>
   ...
   <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      ...
      <rule context="/ubl:Catalogue/cac:ProviderParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B03601">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:ProviderParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B04501">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:ReceiverParty/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B06201">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:ReceiverParty/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B07101">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:SellerSupplierParty/cac:Party/cac:PostalAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B08901">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:RequiredItemLocationQuantity/cac:ApplicableTerritoryAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B18001">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:OriginCountry">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T19-B22401">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:CommodityClassification">
         <assert test="cbc:ItemClassificationCode"
                 flag="warning"
                 id="EHF-T19-B22701">Element 'cbc:ItemClassificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme">
         <assert test="cbc:ID" flag="warning" id="EHF-T19-B24301">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:ManufacturerParty">
         <assert test="cac:PartyName" flag="warning" id="EHF-T19-B25401">Element 'cac:PartyName' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:ManufacturerParty/cac:PartyName">
         <assert test="cbc:Name" flag="warning" id="EHF-T19-B25501">Element 'cbc:Name' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:ItemInstance/cac:LotIdentification">
         <assert test="cbc:LotNumberID" flag="warning" id="EHF-T19-B25901">Element 'cbc:LotNumberID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Catalogue/cac:CatalogueLine/cac:Item/cac:Certificate/cac:IssuerParty">
         <assert test="cac:PartyName" flag="warning" id="EHF-T19-B26801">Element 'cac:PartyName' MUST be provided.</assert>
      </rule>
