<schema xmlns="http://purl.oclc.org/dsdl/schematron"
   ...
   <pattern xmlns:ns2="http://www.schematron-quickfix.com/validator/process">
      <rule context="/ubl:Order">
         ...
         <assert test="cac:BuyerCustomerParty" flag="warning" id="EHF-T01-B00107">Element 'cac:BuyerCustomerParty' MUST be provided.</assert>
         <assert test="cac:SellerSupplierParty" flag="warning" id="EHF-T01-B00108">Element 'cac:SellerSupplierParty' MUST be provided.</assert>
         <assert test="cac:OrderLine" flag="warning" id="EHF-T01-B00109">Element 'cac:OrderLine' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Order/cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme">
         <assert test="cbc:CompanyID" flag="warning" id="EHF-T01-B12501">Element 'cbc:CompanyID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="warning" id="EHF-T01-B12502">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Order/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cac:RegistrationAddress/cac:Country">
         <assert test="cbc:IdentificationCode" flag="warning" id="EHF-T01-B13401">Element 'cbc:IdentificationCode' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Order/cac:AccountingCustomerParty/cac:Party/cac:Contact">
         <assert test="cbc:ID" flag="warning" id="EHF-T01-B13701">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Order/cac:DeliveryTerms/cac:DeliveryLocation">
         <assert test="cbc:ID" flag="warning" id="EHF-T01-B17001">Element 'cbc:ID' MUST be provided.</assert>
      </rule>
      <rule context="/ubl:Order/cac:DeliveryTerms/cac:DeliveryLocation/cbc:ID"/>
      <rule context="/ubl:Order/cac:PaymentTerms">
         <assert test="cbc:Note" flag="warning" id="EHF-T01-B17201">Element 'cbc:Note' MUST be provided.</assert>
      </rule>
      ...
      <rule context="/ubl:Order/cac:OrderLine/cac:LineItem/cac:Item/cac:ClassifiedTaxCategory">
         <assert test="cbc:ID" flag="warning" id="EHF-T01-B24601">Element 'cbc:ID' MUST be provided.</assert>
         <assert test="cac:TaxScheme" flag="warning" id="EHF-T01-B24602">Element 'cac:TaxScheme' MUST be provided.</assert>
      </rule>
