...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="cac:Status/cbc:StatusReasonCode" mode="M8" priority="1000">
...
<!--PATTERN UBL-T71-->
	...
	<!--RULE -->
<xsl:template match="//cac:DocumentReference/cbc:DocumentTypeCode" mode="M9" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:Status/cbc:StatusReasonCode" mode="M9" priority="1002">
    <svrl:fired-rule context="//cac:Status/cbc:StatusReasonCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:DocumentReference/cbc:DocumentTypeCode" mode="M9" priority="1001">
    <svrl:fired-rule context="//cac:DocumentReference/cbc:DocumentTypeCode" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:Response/cbc:ResponseCode" mode="M9" priority="1000">
